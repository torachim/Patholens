...
class MediaAdmin(admin.ModelAdmin):
    ...
    """
    actions = ["syncMediaToDB"]

    def syncMediaToDB(self, request, queryset=None):
        """
    ...
    syncMediaToDB.short_description = "All data sets in the /media folder will be added to the Database"
